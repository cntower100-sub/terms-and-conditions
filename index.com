...
<head>
    ...
    <title>Terms and Conditions · 服务条款</title>
    <style>
        /* === 全局重置 & Word风格 === */
        * {
            margin: 0;
        ...
        body {
            ...
            align-items: center;
            padding: 2.5rem 1rem;
            font-family: 'Calibri', 'Georgia', 'Times New Roman', '宋体', serif;
            line-height: 1.6;
            color: #1e1e1e;
        }
        ...
        a {
            ...
            border-bottom: 1px dotted #7d8ca5;
        }
        a:hover {
            color: #0a1b33;
        ...
        @media (max-width: 640px) {
            ...
            h2 { font-size: 1.4rem; }
            p, li { font-size: 1rem; }
            ul, ol { margin-left: 1.8rem; }
            .legal-quote { margin-left: 0.8rem; padding-left: 1rem; }
        }

        @media print {
            body { background: white; padding: 0.2in; }
            .word-document { box-shadow: none; padding: 0; max-width: 100%; }
        }
...
<div class="word-document">
    ...
    <p>We are Cal Find ("Company," "we," "us," "our").</p>
    ...
    <p>You can contact us by email at <a href="mailto:_cntower100@gmail.com">_cntower100@gmail.com</a>,</p>
    <p>These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), and Li Xin Feng, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. <strong>IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</strong></p>
    ...
    <p class="no-indent toc-item"><strong>1. OUR SERVICES</strong></p>
    <p class="no-indent toc-item"><strong>2. INTELLECTUAL PROPERTY RIGHTS</strong></p>
    <p class="no-indent toc-item"><strong>3. USER REPRESENTATIONS</strong></p>
    <p class="no-indent toc-item"><strong>4. PROHIBITED ACTIVITIES</strong></p>
    <p class="no-indent toc-item"><strong>5. USER GENERATED CONTRIBUTIONS</strong></p>
    <p class="no-indent toc-item"><strong>6. CONTRIBUTION LICENSE</strong></p>
    <p class="no-indent toc-item"><strong>7. SERVICES MANAGEMENT</strong></p>
    <p class="no-indent toc-item"><strong>8. TERM AND TERMINATION</strong></p>
    <p class="no-indent toc-item"><strong>9. MODIFICATIONS AND INTERRUPTIONS</strong></p>
    <p class="no-indent toc-item"><strong>10. GOVERNING LAW</strong></p>
    <p class="no-indent toc-item"><strong>11. DISPUTE RESOLUTION</strong></p>
    <p class="no-indent toc-item"><strong>12. CORRECTIONS</strong></p>
    <p class="no-indent toc-item"><strong>13. DISCLAIMER</strong></p>
    <p class="no-indent toc-item"><strong>14. LIMITATIONS OF LIABILITY</strong></p>
    <p class="no-indent toc-item"><strong>15. INDEMNIFICATION</strong></p>
    <p class="no-indent toc-item"><strong>16. USER DATA</strong></p>
    <p class="no-indent toc-item"><strong>17. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</strong></p>
    <p class="no-indent toc-item"><strong>18. MISCELLANEOUS</strong></p>
    <p class="no-indent toc-item"><strong>19. CONTACT US</strong></p>
    ...
    <p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: <a href="mailto:cntower100@gmail.com">cntower100@gmail.com</a>. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
    ...
    <!-- 原文此处为空白列表项，保留为段落 -->
    <p class="no-indent" style="font-style:italic; color:#2a3850;">(No additional provisions listed in the original document.)</p>
    ...
    <p>These Legal Terms shall be governed by and defined following the laws of the State of Delaware,USA and yourself irrevocably consent that the courts of Delaware shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these Legal Terms.</p>
    ...
    <p>If the parties are unable to resolve the dispute through informal negotiation, the dispute shall be finally resolved by arbitration in accordance with the United Nations Commission on International Trade Law Arbitration Rules in force at the time of commencement of the arbitration. The number of arbitrators shall be 1. The seat, or legal place, or arbitration shall be Wilmington, Delaware, USA. The language of the proceedings shall be English. The governing law of these Legal Terms shall be substantive law of the State of Delaware.</p>
    ...
    <!-- 16. USER DATA -->
    <h2>16. USER DATA</h2>
    <p>We will maintain certain data that you transmit to the Services for the purpose of managing the performance of the Services, as well as data relating to your use of the Services. Although we perform regular routine backups of data, you are solely responsible for all data that you
